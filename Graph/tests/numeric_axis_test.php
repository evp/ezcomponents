...
class ezcGraphNumericAxisTest extends ezcTestCase
{
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [2000 => 70, 12, 39, 87] );
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [2000 => 1, 4.3, .2, 3.82] );
        $chart->render( 500, 200 );
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [2000 => -1.8, 4.3, .2, 3.82] );
        $chart->render( 500, 200 );
    ...
    public function testAutomagicScalingMultiple()
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [2000 => 1045, 1300, 1012, 1450] );
        $chart->data['sample2'] = new ezcGraphArrayDataSet( [2000 => 1270, 1170, 1610, 1370] );
        $chart->render( 500, 200 );
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [4.5] );
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [113.5] );
        $chart->yAxis->majorStep = .5;
        $chart->render( 500, 200 );
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [113.5, 1800, -45] );
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( ['Material1' => 10, 'Material2' => 11.1, 'Material3' => 11.1, 'Material4' => 9.7, 'Material5' => 12.3, 'Material6' => 6.4, 'Material7' => 5.8, 'Material8' => 5.4] );
        $chart->yAxis->min = 0;
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( ["1.2" => 3, "1.25" => 1] );
    ...
    {
        $chart = new ezcGraphLineChart();
        $chart->data['sample'] = new ezcGraphArrayDataSet( [2000 => -300, 1300, 1012, 1450] );
        $chart->yAxis->majorStep = 500;
        $chart->yAxis->position = ezcGraph::LEFT;
        $chart->render( 500, 200 );
    ...
    public function testNullPositionMultipleDataSets()
    {
        ...
        $chart->data['evenMoreData'] = new ezcGraphArrayDataSet( ['sample 1' => 300, 'sample 2' => -30, 'sample 3' => 220, 'sample 4' => 67, 'sample 5' => 450] );
        $chart->render( 500, 200 );
    ...
    public function testRenderedLabels()
    {
        ...
        $expectedLabels = ['-100', '0', '100', '200', '300', '400'];
