...
class ezcGraphDataSetTest extends ezcTestCase
{
    ...
    public function testCreateDataSetFromArray()
    {
        ...
        $chart->data['humanoids'] = new ezcGraphArrayDataSet( ['monkey' => 54, 'ape' => 37, 'human' => 9] );
    ...
    {
        $chart = new ezcGraphPieChart();
        $chart->data['example'] = new ezcGraphArrayDataSet( ['monkey' => 54, 2001 => 37] );
    ...
    {
        $chart = new ezcGraphPieChart();
        $chart->data['example'] = new ezcGraphArrayDataSet( ['monkey' => 'alive', 2001 => 'year'] );
    ...
    {
        $chart = new ezcGraphPieChart();
        $chart->data['income'] = new ezcGraphArrayDataSet( new ArrayIterator( [2000 => 2345.2, 2456.3, 2567.4] ) );
        $chart->data['income'][2005] = 234.21;
