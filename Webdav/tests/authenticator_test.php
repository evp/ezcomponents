...
class ezcWebdavAuthenticatorTest extends ezcTestCase
{
    ...
    {
        return [[new ezcWebdavBasicAuth( 'foo', 'bar' ), true], [new ezcWebdavBasicAuth( 'some', 'thing' ), true], [new ezcWebdavBasicAuth( '23', '42' ), true], [new ezcWebdavBasicAuth( 'in', 'valid' ), false]];
    }

    public static function provideDigestAuthSets()
    {
        return [[new ezcWebdavDigestAuth(
            'GET',
            'Mufasa',
            'testrealm@host.com',
