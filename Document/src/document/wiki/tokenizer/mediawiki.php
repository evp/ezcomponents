    ...
    public function __construct()
    {
        $this->tokens = [
            ...
            */
            ...
            ['class' => 'ezcDocumentWikiDefinitionListItemToken', 'match' => '(\\A\\n(?P<value>[:*#]*:)' . self::WHITESPACE_CHARS . '*)S'],
            ['class' => 'ezcDocumentWikiLiteralLineToken', 'match' => '(\\A\\n(?P<value>' . self::WHITESPACE_CHARS . '))SUs'],
            /*
                array(
            ...
            */
            // Inline markup
            ['class' => 'ezcDocumentWikiMediawikiEmphasisToken', 'match' => '(\\A(?P<value>\'{2,}))S'],
            ['class' => 'ezcDocumentWikiTextLineToken', 'match' => '(\\A(?P<match><nowiki>(?P<value>.+)</nowiki>))SUsi'],
            /*
                array(
