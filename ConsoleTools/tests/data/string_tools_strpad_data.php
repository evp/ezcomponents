...
$testSets = [0 => [
    // $input
    ['input' => 'str_pad()', 'padLegth' => 20],
    // $expected
    'str_pad()           ',
], 1 => [
    // $input
    ['input' => 'str_pad()', 'padLegth' => 20, 'padString' => '-+'],
    // $expected
    'str_pad()-+-+-+-+-+-',
], 2 => [
    // $input
    ['input' => 'str_pad()', 'padLegth' => 20, 'padString' => '-+', 'padType' => STR_PAD_LEFT],
    // $expected
    '-+-+-+-+-+-str_pad()',
], 3 => [
    // $input
    ['input' => 'str_pad()', 'padLegth' => 20, 'padString' => '-+', 'padType' => STR_PAD_RIGHT],
    // $expected
    'str_pad()-+-+-+-+-+-',
], 4 => [
    // $input
    ['input' => 'str_pad()', 'padLegth' => 20, 'padString' => '-+', 'padType' => STR_PAD_BOTH],
    // $expected
    '-+-+-str_pad()-+-+-+',
]];
...
foreach ( $inputStrings as $inputString )
{
    ...
    {
        $testSets[] = [['input'     => $inputString, 'padLength' => $padLength], $results[$i++]];
        $testSets[] = [['input'     => $inputString, 'padLength' => $padLength, 'padString' => $padString], $results[$i++]];
        $testSets[] = [['input'     => $inputString, 'padLength' => $padLength, 'padString' => $padString, 'padType'   => STR_PAD_LEFT], $results[$i++]];
        $testSets[] = [['input'     => $inputString, 'padLength' => $padLength, 'padString' => $padString, 'padType'   => STR_PAD_RIGHT], $results[$i++]];
        $testSets[] = [['input'     => $inputString, 'padLength' => $padLength, 'padString' => $padString, 'padType'   => STR_PAD_BOTH], $results[$i++]];
    }
}
